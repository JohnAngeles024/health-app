...
export default class EditHealth extends Component {
    ...
    componentDidMount() {
        axios.get('https://health-info-app.herokuapp.com/health/'+this.props.match.params.id)
        .then(res => {
            this.setState({
    ...
    onSubmit(e){
        ...
        axios.post('https://health-info-app.herokuapp.com/health/update/'+this.props.match.params.id, health )
